...
baseDIR = "D:\Personal\DAA-System\DAA-System\RTCA DO-365 MOPS_Test_Vectors"
...
if __name__ == "__main__":
    TestResult = {}
    for file in glob.glob(baseDIR + '/' + '*_encounter_characterization_file.csv'):
        result = getTestResult(file)
        TestResult = storeResult(result, file, TestResult)
    with open(destBaseDIR + '\\answer.json', 'w') as outfile:
